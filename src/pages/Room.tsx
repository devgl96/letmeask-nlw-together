...
export function Room() {
    ...
    const { title, questions, background } = useRoom(roomId);
    ...
    return (
        <div id="page-room">
            ...
            <div style={{
                position: 'fixed',
                backgroundImage: background ? `url(${background})`: '#FEFEFE',
                ...
                <div style={{
                    ...
                    backgroundColor: background ? '#d4d0d0ba': '',
                    backgroundSize: 'cover',
                    width: '100%',
                    // minHeight: '100%',
                }}>
                    <main>
                        ...
                        <form onSubmit={handleSendQuestion}>
                            ...
                            <div className="form-footer">
                                ...
                                : 
                                    (<span>Para enviar uma pergunta, <button onClick={loginUser}>faça seu login</button></span>)}
